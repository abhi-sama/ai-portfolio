...
import { IconCheck, type ReactNode } from "@tabler/icons-react";
...
export async function ServicesSection() {
  ...
  const featured = services.filter((s: { featured: any }) => s.featured);
  const regular = services.filter((s: { featured: any }) => !s.featured);
