...
export async function AchievementsSection() {
  ...
  const featured = achievements.filter((a: { featured: any }) => a.featured);
  const regular = achievements.filter((a: { featured: any }) => !a.featured);
                        ...
                        <div className="relative w-full h-32 @md/card:h-48 mb-4 rounded-lg overflow-hidden">
                          <Image
                            src={urlFor(achievement.image)
                              ...
                              .height(200)
                              .url()}
                            alt={String(achievement.title) || "Achievement"}
                            fill
